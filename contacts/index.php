                    ...
                    <div class="contacts-links">
                        ...
                        <div class="adress  contact">
                            ...
                            <div class="social-link">
                                <a href="<?=sprint_options_get('FACEBOOK_CONTACTS_URL')?>" target="_blank" class="facebook">
                                ...
                                <a href="<?=sprint_options_get('INSTAGRAM_CONTACTS_URL')?>" target="_blank" class="inst">
                                    <svg width="35" height="35" viewBox="0 0 35 35" fill="none"
                                         xmlns="http://www.w3.org/2000/svg">
                                ...
                                <a href="<?=sprint_options_get('VK_CONTACTS_URL')?>" target="_blank" class="vk">
                                    <svg width="35" height="35" viewBox="0 0 35 35" fill="none"
                                         xmlns="http://www.w3.org/2000/svg">
