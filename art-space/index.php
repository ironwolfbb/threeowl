                        ...
                        <div class="art-grid-block">
                            <div class="exposition">
                                <div class="expos-header"
                                     style="background-image: url('<?= SITE_TEMPLATE_PATH ?>/img/expos1.jpg');">
                                                ...
                                                <defs>
                                                    <filter id="filter0_d_1743_16805" x="0" y="0" width="50" height="50"
                                                        ...
                                                        <feBlend mode="normal" in="SourceGraphic"
                                                                 in2="effect1_dropShadow_1743_16805"
                                                                 result="shape"/>
                                                    </filter>
                                            ...
                                            <svg width="50" height="50" viewBox="0 0 50 50" fill="none"
                                                ...
                                                <defs>
                                                    <filter id="filter0_d_1743_16809" x="0" y="0" width="50" height="50"
                                                        ...
                                                        <feBlend mode="normal" in="SourceGraphic"
                                                                 in2="effect1_dropShadow_1743_16809"
                                                                 result="shape"/>
                                                    </filter>
                                            ...
                                            <svg width="50" height="50" viewBox="0 0 50 50" fill="none"
                                                ...
                                                <defs>
                                                    <filter id="filter0_d_1743_16815" x="0" y="0" width="50" height="50"
                                                        ...
                                                        <feBlend mode="normal" in="SourceGraphic"
                                                                 in2="effect1_dropShadow_1743_16815"
                                                                 result="shape"/>
                                                    </filter>
                                                </defs>
                                            </svg>
                            ...
                            <div class="exposition">
                                <div class="expos-header"
                                     style="background-image: url('<?= SITE_TEMPLATE_PATH ?>/img/expos2.jpg');">
                                    <div class="expos-likes">
                                        <a href="#">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30"
                                                 viewBox="0 0 30 30"
