...
$(".services-scroll").on("click", function () {
  $("html,body").animate(
    { scrollTop: $("#services-block-main").offset().top + "px" },
    { duration: 1e3 }
  );
});
$(".stocks-scroll").on("click", function () {
  $("html,body").animate(
    { scrollTop: $("#stocks-block").offset().top + "px" },
    { duration: 1e3 }
  );
});
$(".cases").on("click", function () {
  $("html,body").animate(
    { scrollTop: $("#scrolling-block").offset().top + "px" },
    { duration: 1e3 }
  );
});
...
$(".phoneInput input").mask("+7(999) 999-9999");
...
document.addEventListener("click", function (e) {
  ...
  if (e.target.closest(".js-detail-photo-slider .swiper-slide")) {
    document
      .querySelector(".popup-detail-slider-block")
  ...
  if (
    e.target.closest(".katalog-btn") ||
    e.target.classList.contains("katalog-btn")
  ) {
    document.querySelector(".header-bottom-links").classList.toggle("active");
  }
  if (
    e.target.closest(".catalog-close-btn") ||
    e.target.classList.contains("catalog-close-btn")
  ) {
    document.querySelector(".header-bottom-links").classList.toggle("active");
  }
  ...
  if (
    ...
    e.target.classList.contains("search-img")
  ) {
  ...
  if (e.target.closest(".agreement")) {
    ...
    document.getElementById("8").checked = document
  ...
  if (e.target.closest(".js-exposition")) {
    ...
    document.querySelector(".photo-modal-img").querySelector("img").src =
      image_src;
    document.querySelector(".popup-detail-modal").classList.toggle("active");
    document.querySelector(".body").classList.toggle("noScroll");
  }
...
let smallestSlides = document.querySelectorAll(
  ".js-smallest-detail-slider .swiper-slide"
);
let imgsSrc = [];
...
function create_article_div(
  ...
  bottom_div.classList = "exposition-bottom blog-section";
  let catalog_item = document.createElement("div");
  catalog_item.classList = "catalog-item";
  let expos_author_div = document.createElement("div");
  expos_author_div.classList = "expos-authorr";
  let author_img = document.createElement("img");
  author_img.src = author_image;
  let author_caption = document.createElement("p");

  author_caption.innerHTML = author_name;
  expos_author_div.appendChild(author_img);
  ...
  likes_a.innerHTML = like_svg;
  likes_p = document.createElement("p");
  likes_p.innerHTML = likes;
  likes_a.appendChild(likes_p);
  likes_div.appendChild(likes_a);

  social_links_div = document.createElement("div");
  social_links_div.classList = "social-link";
  facebook_a = document.createElement("a");
  facebook_a.classList = "facebook";
  if(facebook_a.href = facebook_link){
   facebook_a.innerHTML = facebook_svg;
  };
  inst_a = document.createElement("a");
  inst_a.classList = "inst";
  if(inst_a.href = inst_link){
   inst_a.innerHTML = inst_svg;
  };
  vk_a = document.createElement("a");
  vk_a.classList = "vk";
  if(vk_a.href = vk_link){
  vk_a.innerHTML = vk_svg
  };
  

  social_links_div.appendChild(facebook_a);
  social_links_div.appendChild(inst_a);
  social_links_div.appendChild(vk_a);
 

  header_div.appendChild(likes_div);
  ...
  $.ajax({
    ...
    success: function (data) {
      ...
      if (data.LIST.length < data.TOTAL) {
        ...
        section_div.removeChild(
          section_div.querySelector(".btn.btn-orange.art-btn")
        );
  ...
  $.ajax({
    ...
    success: function (data) {
      ...
      if (data.LIST.length < data.TOTAL) {
        ...
        load_more_div.appendChild(load_more_a);
        if (
          section_div.getElementsByClassName("btn btn-orange art-btn").length >
          0
        ) {
          section_div.removeChild(
            section_div.querySelector(".btn.btn-orange.art-btn")
...
let articleHashtags = document.querySelectorAll(".articles-hashtags a");
